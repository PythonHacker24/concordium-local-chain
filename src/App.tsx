...
function Installer() {
  ...
  return (
    <div className="container prose md:prose-lg lg:prose-xl m-auto">
      ...
      <CButton
        className={`bg-ctp-blue mx-auto w-4/5 sm:w-34 md:w-44  text-lg inline-flex items-center justify-center  text-center font-extrabold text-normal text-slate-800 hover:text-slate-700 lg:px-8 xl:px-10 mb-3 ${
          installing
            ? "bg-ctp-sky"
      ...
      <CButton
        className={`bg-ctp-blue mx-auto w-4/5 sm:w-34 md:w-44 hover:bg-ctp-sky text-lg inline-flex items-center justify-center  text-center font-extrabold text-normal text-slate-800 hover:text-slate-700 lg:px-8 xl:px-10 mb-3 ${
          installingCreator
            ? "bg-ctp-sky"
