...
const AdvancedSettingsPage: FC<AdvancedSettingsPageProps> = ({
  onHandleSubmit,
}) => {
  const [visible, setVisible] = useState(false);
  const [formData, setFormData] = useState(
    localStorage.getItem("advancedConfig")
      ? JSON.parse(localStorage.getItem("advancedConfig") as any)
      : {
          protocolVersion: "5",
          out: {
